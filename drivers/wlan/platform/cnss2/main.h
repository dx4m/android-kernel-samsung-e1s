...
extern int exynos_esca_read_reg(struct device_node *esca_mfd_node, u8 sid, u16 type, u8 reg, u8 *dest);
#endif
...
#if IS_ENABLED(CONFIG_CNSS_EXYNOS)
#define POWER_ON_RETRY_MAX_TIMES        2
#define LINK_FAILURE_POWER_ON_RETRY_DELAY_MS 2000
#else
#define POWER_ON_RETRY_MAX_TIMES        4
#endif /* CONFIG_CNSS_EXYNOS */
#endif
...
struct cnss_plat_data {
	...
	int clk_req_gpio;
	int clk_req_irq;
	struct notifier_block smmu_fault_nb;
#endif
