...
#define SLSI_VENDOR_FEATURE_RSN_OVERRIDE_STA BIT(0)
...
enum slsi_roaming_trigger_event_value {
	...
	SLSI_SOFT_ROAMING_TRIGGER_EVENT_EXPIRED_TIMER
};
...
enum slsi_acs_attr_offload {
	...
	SLSI_ACS_ATTR_BAND,
	SLSI_ACS_ATTR_EHT_ENABLED,
	SLSI_ACS_ATTR_LINK_ID,
	/* keep last */
...
enum slsi_hal_vendor_subcmds {
	...
	SLSI_NL80211_VENDOR_SUBCMD_GET_CONCURRENCY_MATRIX,
...
enum slsi_supp_vendor_subcmds {
	...
	SLSI_NL80211_VENDOR_SUBCMD_GET_FEATURES
};
...
enum slsi_vendor_event_values {
	...
	SLSI_NL80211_NDP_REQ_EVENT,
	SLSI_NL80211_NDP_CFM_EVENT,
	SLSI_NL80211_NDP_END_EVENT,
...
enum slsi_uc_iface_mode {
	...
	SLSI_UC_ITERFACE_NAN = 1 << 5,
	SLSI_UC_ITERFACE_MESH = 1 << 6,
	SLSI_UC_ITERFACE_TDLS = 1 << 7,
...
enum slsi_concurrency_matrix_attr {
	SLSI_ATTRIBUTR_MAX_SET_SIZE = 1,
	SLSI_ATTRIBUTE_NUM_IFACE_COMB,

	SLSI_ATTRIBUTE_IFACE_COMB,
	SLSI_ATTRIBUTE_MAX_IFACE,
	SLSI_ATTRIBUTE_NUM_IFACE_LIMITS,

	SLSI_ATTRIBUTE_WIFI_IFACE_LIMIT,
	SLSI_ATTRIBUTE_MAX_LIMIT,
	SLSI_ATTRIBUTE_IFACE_MASK,
	SLSI_ATTRIBUTE_CONCURRENCY_MATRIX_MAX
};

enum slsi_get_features_attr {
	SLSI_VENDOR_ATTR_FEATURE_FLAGS,
	SLSI_VENDOR_ATTR_FEATURE_MAX
};
