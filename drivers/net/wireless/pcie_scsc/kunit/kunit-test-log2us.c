...
static void test_slsi_conn_log2us_auth_req(struct kunit *test)
{
	...
	ndev_vif->iftype = NL80211_IFTYPE_AP;
	slsi_conn_log2us_auth_req(sdev, dev, bssid, auth_algo, sae_type, sn, status, tx_status, true, -40);
	...
	slsi_conn_log2us_auth_req(sdev, dev, bssid, auth_algo, sae_type, sn, status, tx_status, false, -40);
...
static void test_slsi_conn_log2us_assoc_req(struct kunit *test)
{
	...
	ndev_vif->iftype = NL80211_IFTYPE_AP;
	slsi_conn_log2us_assoc_req(sdev, dev, bssid, sn, tx_status, mgmt_frame_subtype, 100);

	ndev_vif->iftype = NL80211_IFTYPE_STATION;
	slsi_conn_log2us_assoc_req(sdev, dev, bssid, sn, tx_status, mgmt_frame_subtype, -40);
...
static void test_slsi_conn_log2us_deauth(struct kunit *test)
{
	...
	ndev_vif->iftype = NL80211_IFTYPE_AP;
	slsi_conn_log2us_deauth(sdev, dev, str_type, bssid, sn, status, vs_ie, -40);
...
static void test_slsi_conn_log2us_disassoc(struct kunit *test)
{
	...
	ndev_vif->iftype = NL80211_IFTYPE_AP;
	slsi_conn_log2us_disassoc(sdev, dev, str_type, bssid, sn, status, vs_ie, -40);
