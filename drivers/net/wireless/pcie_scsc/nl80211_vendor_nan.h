...
#define SLSI_NAN_TLV_NAN_PAIRING_CONFIG              0x0116
#define SLSI_NAN_TLV_NAN_IDENTITY_KEY                0x0117
#define SLSI_NAN_TLV_NAN_IDENTITY_RESOLUTION_ATTR    0x0118
#define SLSI_NAN_TLV_NAN_BOOTSTRAPPING_INFO          0x0121
#define SLSI_NAN_TLV_NAN_BOOTSTRAPPING_COMEBACK_INFO 0x011a
...
#define SLSI_NAN_MAX_HOST_BOOTSTRAPPING_REQ 255
#define SLSI_NAN_MAX_BOOTSTRAPPING_INSTANCES 255
#define SLSI_NAN_MAX_PAIRING_INSTANCES 64
...
enum SLSI_NAN_REPLY_ATTRIBUTES {
	...
	NAN_REPLY_ATTR_SET_COMMAND_RESP_LEN,
	NAN_REPLY_ATTR_SET_COMMAND_RESP,
	NAN_REPLY_ATTR_BOOTSTRAPPING_INSTANCE_ID,
	NAN_REPLY_ATTR_PAIRING_INSTANCE_ID,
	NAN_REPLY_ATTR_PAIRING_OWN_DISC_MAC_ADDR,
	NAN_REPLY_ATTR_PAIRING_PEER_DISC_MAC_ADDR,
	NAN_REPLY_ATTR_PAIRING_BSSID_MAC_ADDR,
	NAN_REPLY_ATTR_PAIRING_PUBLISH_ID,
...
enum SLSI_NAN_REQ_ATTRIBUTES {
	...
	NAN_REQ_ATTR_INSTANT_MODE_CHANNEL = 151,
	NAN_REQ_ATTR_SET_COMMAND_LEN,
	NAN_REQ_ATTR_SET_COMMAND,
	NAN_REQ_ATTR_NIK,
	NAN_REQ_ATTR_PAIRING_CFG_ENABLE_PAIRING_SETUP,
	NAN_REQ_ATTR_PAIRING_CFG_ENABLE_PAIRING_CACHE,
	NAN_REQ_ATTR_PAIRING_CFG_ENABLE_PAIRING_VERIFICATION,
	NAN_REQ_ATTR_PAIRING_CFG_SUPPORTED_BOOTSTRAPPING_METHODS,
	NAN_REQ_ATTR_BOOTSTRAPPING_REQUESTOR_INSTANCE_ID,
	NAN_REQ_ATTR_BOOTSTRAPPING_PEER_DISC_MAC_ADDR,
	NAN_REQ_ATTR_BOOTSTRAPPING_REQUEST_BOOTSTRAPPING_METHOD = 161,
	NAN_REQ_ATTR_BOOTSTRAPPING_SERVICE_SPECIFIC_INFO_LEN,
	NAN_REQ_ATTR_BOOTSTRAPPING_SERVICE_SPECIFIC_INFO,
	NAN_REQ_ATTR_BOOTSTRAPPING_SDEA_LEN,
	NAN_REQ_ATTR_BOOTSTRAPPING_SDEA,
	NAN_REQ_ATTR_BOOTSTRAPPING_SERVICE_INSTANCE_ID,
	NAN_REQ_ATTR_BOOTSTRAPPING_COME_BACK_DELAY,
	NAN_REQ_ATTR_BOOTSTRAPPING_COOKIE_LEN,
	NAN_REQ_ATTR_BOOTSTRAPPING_COOKIE,
	NAN_REQ_ATTR_BOOTSTRAPPING_RESPONSE_CODE,
	NAN_REQ_ATTR_PAIRING_REQUESTOR_INSTANCE_ID = 171,
	NAN_REQ_ATTR_PAIRING_PEER_DISC_MAC_ADDR,
	NAN_REQ_ATTR_PAIRING_REQUEST_TYPE,
	NAN_REQ_ATTR_PAIRING_IS_OPPORTUNISTIC,
	NAN_REQ_ATTR_PAIRING_ENABLE_PAIRING_CACHE,
	NAN_REQ_ATTR_PAIRING_INSTANCE_ID,
	NAN_REQ_ATTR_PAIRING_RESPONSE_CODE,
	NAN_REQ_ATTR_SECURITY_AKM,
	NAN_REQ_ATTR_PASN_SEND_MLME_LEN,
	NAN_REQ_ATTR_PASN_SEND_MLME,
	NAN_PASN_SET_KEY_OWN_ADDR,
	NAN_PASN_SET_KEY_PEER_ADDR,
	NAN_PASN_SET_KEY_NM_TK_LEN,
	NAN_PASN_SET_KEY_NM_TK,
	NAN_PASN_SET_KEY_NM_KEK_LEN,
...
enum SLSI_NAN_EVT_ATTRIBUTES {
	...
	NAN_EVT_ATTR_SET_COMMAND_EVENT_IND_LEN,
	NAN_EVT_ATTR_SET_COMMAND_EVENT_IND,
	NAN_EVT_ATTR_PAIRING_CFG_ENABLE_PAIRING_SETUP,
	NAN_EVT_ATTR_PAIRING_CFG_ENABLE_PAIRING_CACHE,
	NAN_EVT_ATTR_PAIRING_CFG_ENABLE_PAIRING_VERIFICATION = 80,
	NAN_EVT_ATTR_PAIRING_CFG_SUPPORTED_BOOTSTRAPPING_METHODS,
	NAN_EVT_ATTR_PAIRING_NIRA_NONCE,
	NAN_EVT_ATTR_PAIRING_NIRA_TAG,
	NAN_EVT_ATTR_BOOTSTRAPPING_PUBLISH_SUBSCRIBE_ID,
	NAN_EVT_ATTR_BOOTSTRAPPING_REQUESTOR_INSTANCE_ID,
	NAN_EVT_ATTR_BOOTSTRAPPING_ADDR,
	NAN_EVT_ATTR_BOOTSTRAPPING_METHOD,
	NAN_EVT_ATTR_BOOTSTRAPPING_INSTANCE_ID,
	NAN_EVT_ATTR_BOOTSTRAPPING_RSP_CODE,
	NAN_EVT_ATTR_BOOTSTRAPPING_REASON_CODE = 90,
	NAN_EVT_ATTR_BOOTSTRAPPING_COME_BACK_DELAY,
	NAN_EVT_ATTR_BOOTSTRAPPING_COOKIE_LENGTH,
	NAN_EVT_ATTR_BOOTSTRAPPING_COOKIE,
	NAN_EVT_ATTR_PAIRING_PUBLISH_SUBSCRIBE_ID,
	NAN_EVT_ATTR_PAIRING_PAIRING_INSTANCE_ID,
	NAN_EVT_ATTR_PAIRING_REQUESTOR_INSTANCE_ID,
	NAN_EVT_ATTR_PAIRING_PEER_DISC_MAC_ADDR,
	NAN_EVT_ATTR_PAIRING_REQUEST_TYPE,
	NAN_EVT_ATTR_PAIRING_ENABLE_PAIRING_CACHE,
	NAN_EVT_ATTR_PAIRING_RSP_CODE = 100,
	NAN_EVT_ATTR_PAIRING_REASON_CODE,
	NAN_EVT_ATTR_PAIRING_PEER_NIK,
	NAN_EVT_ATTR_PAIRING_LOCAL_NIK,
	NAN_EVT_ATTR_PAIRING_NPK_SECURITYY_ASSOC_PMK_LEN,
	NAN_EVT_ATTR_PAIRING_NPK_SECURITYY_ASSOC_PMK,
	NAN_EVT_ATTR_PAIRING_NPK_SECURITY_ASSOC_AKM,
	NAN_EVT_ATTR_PAIRING_NPK_SECURITY_ASSOC_CIPHER_TYPE,
	NAN_EVT_ATTR_NAN_PAIRING_PASN_RECV_AUTH_TRANSACTION,
	NAN_EVT_ATTR_NAN_PAIRING_PASN_RECV_FRAME_LEN,
	NAN_EVT_ATTR_NAN_PAIRING_PASN_RECV_FRAME
};
...
#define SLSI_HAL_NAN_MAX_SET_COMMAND_LEN 255
#define SLSI_HAL_NAN_PAIRING_CONFIG_LEN 8
#define SLSI_HAL_NAN_IDENTITY_KEY_LEN 16
#define SLSI_HAL_NAN_COOKIE_LEN 255
...
enum slsi_wifi_hal_nan_status_type {
	...
	/* If pairing instance id is full */
	SLSI_HAL_NAN_STATUS_INVALID_PAIRING_ID = 13,
	/* If bootstrapping instance id is full */
	SLSI_HAL_NAN_STATUS_INVALID_BOOTSTRAPPING_ID = 14,
	/* If same request is received again */
	SLSI_HAL_NAN_STATUS_REDUNDANT_REQUEST = 15
};
...
enum slsi_nan_bootstrapping_request_type {
	NAN_BOOTSTRAPPING_REQUEST = 1,
	NAN_BOOTSTRAPPING_RESPONSE
};

enum slsi_nan_bootstrapping_response_code {
	NAN_BOOTSTRAPPING_RESPONSE_ACCEPT = 0,
	NAN_BOOTSTRAPPING_RESPONSE_REJECT,
	NAN_BOOTSTRAPPING_RESPONSE_COMEBACK
};

enum slsi_nan_pairing_response_code {
	NAN_PAIRING_RESPONSE_ACCEPT = 0,
	NAN_PAIRING_RESPONSE_REJECT
};
...
struct slsi_nan_pairing_config {
...
struct slsi_nan_bootstrapping_comebackinfo {
	u32 comeback_delay;
	u16 cookie_length;
	u8 cookie[SLSI_HAL_NAN_COOKIE_LEN];
};

#define NAN_IDENTITY_NONCE_LEN 8
#define NAN_IDENTITY_TAG_LEN 8
/* The NIRA used to identify the peer pairing devices*/
struct slsi_nan_nik_resolution_attr {
...
struct slsi_nan_npk_security_associate {
	/* The inentity key of peer device*/
	u8 peer_nan_identity_key[SLSI_HAL_NAN_IDENTITY_KEY_LEN];
	/* The inentity key of local device*/
	u8 local_nan_identity_key[SLSI_HAL_NAN_IDENTITY_KEY_LEN];
...
struct slsi_hal_nan_publish_req {
	...
	/* Pairing Config */
	struct slsi_nan_pairing_config pairing_cfg;

	/* The Identity key for pairing, used to generate NIRA */
	u8 nan_identity_key[SLSI_HAL_NAN_IDENTITY_KEY_LEN];
};
...
struct slsi_hal_nan_bootstrapping_req {
	u16 transaction_id;

	/* This Id is generated in Driver for new bootstrapping instance id */
	...
	struct slsi_nan_bootstrapping_comebackinfo comebackinfo;
};

struct slsi_hal_nan_bootstrapping_rsp {
	u16 transaction_id;

	/* ID of bootstrapping session.
	 *  Used to identify the bootstrapping further negotiation/APIs.
	 */
	u16 bootstrapping_instance_id;
...
struct slsi_hal_nan_pairing_req {
	u16 transaction_id;
...
struct slsi_hal_nan_pairing_rsp {
	u16 transaction_id;
	u32 pairing_instance_id;
	u8 match_id;
	u8 session_id;
...
struct slsi_hal_nan_pairing_end {
	u32 pairing_instance_id;
	u16 transaction_id;
	u8 session_id;
	u8 peer_disc_mac_addr[ETH_ALEN];
...
struct slsi_hal_nan_bootstrapping_requested_ind {
	u16 publish_subscribe_id;
	u32 requestor_instance_id;
	u8 peer_disc_mac_addr[ETH_ALEN];
...
struct slsi_hal_nan_bootstrapping_confirm_ind {
	u32 bootstrapping_id;
	u8 response;
	u8 reason_code;
	struct slsi_nan_bootstrapping_comebackinfo comebackinfo;
...
struct slsi_hal_nan_pairing_requested_ind {
	u16 publish_subscribe_id;
	u32 requestor_instance_id;
	u8 peer_disc_mac_addr[ETH_ALEN];
	u32 pairing_instance_id;
	u8 pairing_request_type;
	u8 pairing_enable_pairing_cache;
	struct slsi_nan_nik_resolution_attr nik_resolution_attr;
};

struct slsi_hal_nan_pairing_request_ind {
	u8 peer_nmi_address[ETH_ALEN];
	u16 session_id;
};

struct slsi_hal_nan_pairing_response_ind {
	u8 peer_nmi_address[ETH_ALEN];
	u16 session_id;
};

struct slsi_hal_nan_pairing_confirm_ind {
	u8 peer_nmi_address[ETH_ALEN];
	u32 pairing_instance_id;
	u8 response;
	u8 reason_code;
	...
	u8 pairing_enable_pairing_cache;
	u8 islocalnik;
	struct slsi_nan_npk_security_associate npk_security_association;
};
...
struct slsi_nan_data_iface_create_delete {
	struct list_head list;
	u8 ifname[IFNAMSIZ];
	int transaction_id;
	enum interface_action iface_action;
};
#endif
...
struct slsi_hal_nan_vendor_cmd_data{
	u16 transaction_id;
	u16 cmd_req_len;
	u8 cmd_req[];
};

struct slsi_hal_nan_vendor_cmd_resp_data{
	u16 transaction_id;
	u16 cmd_resp_len;
	u8 cmd_resp[];
};

struct slsi_hal_nan_vendor_prev_cmd_data_info {
	struct list_head list;
	u8 prev_cmd_req[];
};

struct slsi_nan_pasn_send_mlme_params {
	u8 frame[SLSI_NAN_MAX_MGMT_LEN];
	u16 frame_len;
};

struct slsi_nan_pasn_recv_mlme_params {
	u8 auth_transaction;
	u8 frame[SLSI_NAN_MAX_MGMT_LEN];
	u16 frame_len;
};

struct slsi_nan_pasn_params {
	u8 own_disc_mac_addr[ETH_ALEN];
	u8 peer_disc_mac_addr[ETH_ALEN];
	u8 bssid_mac_addr[ETH_ALEN];
	u8 publish_id;
	u8 dialog_token;
	u16 bootstrapping_method;
	u8 local_nonce[NAN_IDENTITY_NONCE_LEN];
	u8 local_tag[NAN_IDENTITY_TAG_LEN];
};

struct slsi_nan_pasn_set_key_params {
